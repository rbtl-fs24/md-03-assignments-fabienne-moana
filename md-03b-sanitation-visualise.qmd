...
sanitation_AFG <- sanitation |>
  filter(iso3 == "AFG", (year == 2000 | year == 2020), varname_short != "san_sm")
```
...
1.  Look at the plot that you created. What do you notice about the order of the bars / order of the legend?
    ...
    The sanitation services get less improved/ worse when going down the legend and bars.

2.  What would you want to change?

    I would put the best/most improved sanitation services at the bottom and the less improved at the top

3.  Why did we remove "safely managed sanitation services" from the data set in Task 3?

    Because it would have distorted the bar plot and we are interested in the data which shows what there still is to improve.
